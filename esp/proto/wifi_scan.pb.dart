...
class CmdScanStart extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'esp'),
      createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'blocking')
    ..aOB(2, _omitFieldNames ? '' : 'passive')
    ..a<$core.int>(
        3, _omitFieldNames ? '' : 'groupChannels', $pb.PbFieldType.OU3)
...
class WiFiScanResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$0.WifiAuthMode>(5, _omitFieldNames ? '' : 'auth', $pb.PbFieldType.OE,
