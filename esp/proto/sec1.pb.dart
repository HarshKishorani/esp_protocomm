...
class SessionCmd1 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionCmd1', package: const $pb.PackageName(_omitMessageNames ? '' : 'local_ctrl'), createEmptyInstance: create)
...
class SessionResp1 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionResp1', package: const $pb.PackageName(_omitMessageNames ? '' : 'local_ctrl'), createEmptyInstance: create)
...
class SessionCmd0 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionCmd0', package: const $pb.PackageName(_omitMessageNames ? '' : 'local_ctrl'), createEmptyInstance: create)
...
class SessionResp0 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionResp0', package: const $pb.PackageName(_omitMessageNames ? '' : 'local_ctrl'), createEmptyInstance: create)
    ..e<$0.Status>(1, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.Status.Success, valueOf: $0.Status.valueOf, enumValues: $0.Status.values)
...
class Sec1Payload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Sec1Payload', package: const $pb.PackageName(_omitMessageNames ? '' : 'local_ctrl'), createEmptyInstance: create)
    ..oo(0, [20, 21, 22, 23])
