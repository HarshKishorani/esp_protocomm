...
class S0SessionCmd extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'S0SessionCmd', package: const $pb.PackageName(_omitMessageNames ? '' : 'local_ctrl'), createEmptyInstance: create)
...
class S0SessionResp extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'S0SessionResp', package: const $pb.PackageName(_omitMessageNames ? '' : 'local_ctrl'), createEmptyInstance: create)
...
class Sec0Payload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Sec0Payload', package: const $pb.PackageName(_omitMessageNames ? '' : 'local_ctrl'), createEmptyInstance: create)
    ..oo(0, [20, 21])
