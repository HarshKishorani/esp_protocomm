...
class CmdGetStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CmdGetStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'esp'), createEmptyInstance: create)
...
class RespGetStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RespGetStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'esp'), createEmptyInstance: create)
    ..oo(0, [10, 11])
...
class CmdSetConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CmdSetConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'esp'), createEmptyInstance: create)
...
class RespSetConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RespSetConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'esp'), createEmptyInstance: create)
    ..e<$1.Status>(1, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.Status.Success, valueOf: $1.Status.valueOf, enumValues: $1.Status.values)
    ..hasRequiredFields = false
  ;
...
class CmdApplyConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CmdApplyConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'esp'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class RespApplyConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RespApplyConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'esp'), createEmptyInstance: create)
    ..e<$1.Status>(1, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.Status.Success, valueOf: $1.Status.valueOf, enumValues: $1.Status.values)
    ..hasRequiredFields = false
  ;
...
class WiFiConfigPayload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WiFiConfigPayload', package: const $pb.PackageName(_omitMessageNames ? '' : 'esp'), createEmptyInstance: create)
